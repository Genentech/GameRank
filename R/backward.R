...
#' 
#' @description Starts with the full set of available features and removes the 
#' worst feature during each iteration until determined partition size is 
#' reached. In case of ties, all partitions are explored.
#' 
...
#'  - an integer number determing the number of random training:validation 
...
#' resp <- "resp"
#' res <- backward( toy_data, resp, vars, 
