...
#' 
#' @description Starts with the empty set of available features and adds 
#' the best feature
#' during each iteration until determined partition size is reached. In case of 
#' ties, all partitions are explored.
#' 
...
#' resp <- "resp"
#' res <- forward( toy_data, resp, vars, 
#'                 fn_train_binomial, fn_eval_binomial_auroc, 4L, 1L, TRUE )
